export default {
    ...
    "活动期间，用户通过分享邀请码邀请新用户注册，满足条件后，即可获得奖励：": "During the promotional period, users can invite new users to register by sharing their invitation code, and after meeting the conditions, they can receive rewards.",
    "1. 活动时限：15天": "1. Promotional period: 15 days.",
    "2. 新用户需完成实名认证和上架产品": "2. New users must complete identity verification and upload products.",
    "3. 被邀用户在平台上完成首单之日起计算，15天内的订单完成后，系统结算该用户的交易总额并向邀请者派发奖励": "3. Starting from the day the invited user completes their first order on the platform, the total transaction amount will be calculated within 15 days after the order is completed, and rewards will be distributed to the inviter.",
    "被邀用户完成订单": "The invited user completes the order.",
    "订单总额比例": "Total order amount ratio.",
    "超时订单": "Overdue orders.",
    "本次活动资金由TikTok支持，活动总资金100,000,000USD,快来瓜分吧！": "This promotional event is funded by TikTok, with a total fund of 100,000,000 USD to share! Come and join us!",
    "资金结束即活动结束，赶快邀请你的朋友加入吧！": "Once the funds are exhausted, the event will end. Hurry up and invite your friends to join!",
    ...
    "首次上架账户资金≥{_1}，请充值后再试": "The funds of the first listed account are ≥ {_1}, please deposit and try again",
    ...
    "请前往{_1}继续完成支付": "Please go to {_1} to complete the payment",
    ...
    "customer_service_time": "Dear user, the customer service hours are {start} - {end}. Please leave a message.",
	"银行卡绑定":"Bank card binding",
	"银行卡已绑定":"Bank card bound",
	"卡号已存在":"Card already exists",
	"微信绑定手机号":"WeChat binding phone number",
	"快件已出库,正在发往下一站":"The package has been shipped out and is currently being sent to the next station",
	"快件已装车,正在发往中转中心":"The package has been loaded onto the truck and is being sent to the transit center",
	"快递到达区域中转站,正在派送至城市分拣中心":"The express delivery has arrived at the regional transfer station and is currently being delivered to the city sorting center",
	"快递送达城市分拣中心,正在分拣":"The package has been delivered to the city sorting center and is currently being sorted",
	"快递分拣完毕,正在出库派送中":"The parcel sorting has been completed and is currently being dispatched from the warehouse",
	"订单已签收":"The user has signed for it and the shipment has been completed. Thank you for your patience!",
	"采购资金":"Procurement funds",
	"上传微信收款码（需保存收款码到相册)":"Upload WeChat payment code (need to save the payment code to the album)",
	...
	"您的提现成功,金额":"Your withdrawal was successful, with an amount of {value}U",
	"您的提现失败,金额":"Your withdrawal failed, amount {value}U",
	"您的资金被冻结,金额":"Your funds have been frozen, with an amount of {value}U",
	"您的资金已解冻,金额":"Your funds have been unfrozen, with an amount of {value}U",
	...
	"提现":"Withdrawal",
	"买家":"buyer",
	"大于店铺设置最大上架商品数":"Exceeding the maximum number of products listed in the store setting",
	"用户":"user",
	"退出登录":"Log Out",
	"已付款":"paid",
	"发货中":"Shipping",
