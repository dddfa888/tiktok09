...
export const lotteryInfo = (data) => request({
    url: '/api/activity/lottery!detail.action',
    method: METHODS.GET,
    params: data
})
...
export const getPoints = (data) => request({
    url: '/api/activity/lottery!getPoints.action',
    method: METHODS.GET,
    params: data
})
...
export const lotteryDraw = (data) => request({
    url: '/api/activity/lottery!draw.action',
    method: METHODS.POST,
    params: data
})
...
export const lotteryCountPrize = (data) => request({
    url: '/api/activity/lottery!countPrize.action',
    method: METHODS.GET,
    params: data
})
...
export const receivePrize = (data) => request({
    url: '/api/activity/lottery!receivePrize.action',
    method: METHODS.POST,
    params: data
})
...
export const getCountPoints = (data) => request({
    url: '/api/activity/lottery!getCountPoints.action',
    method: METHODS.POST,
    params: data
})
...
export const pageListMyPrize = (data) => request({
    url: '/api/activity/lottery!pageListMyPrize.action',
    method: METHODS.GET,
    params: data
})
