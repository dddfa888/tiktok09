...
// 个性化返回错误提示信息接口
const diyUrlData = [
  '/wap/seller/goods!update.action',
  '/wap/seller/goods!addOrUpdate.action',
  '/wap/api/cms!get.action'
]

// 活动接口个性化未登录
const diyLogoutData = [
  '/wap/api/activity/lottery!getPoints.action',
  '/wap/api/activity/lottery!draw.action',
  '/wap/api/activity/lottery!pageListMyPrize.action'
]
...
const service = axios.create({
  // baseURL: BASE_URL,
  // baseURL: "http://192.168.0.150:8081/",
  baseURL: 'https://www.abayb.com/wap/',
