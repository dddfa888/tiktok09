...
export const bindEmailOrPhoneSm = (params) => {
    return request({
        url: "/api/localuser!bindEmailOrPhoneSm.action",
        method: METHODS.POST,
        data: params
    })
};
...
export const messageSlidelist = (data) => {
    return request({
        url: '/api/notification!message.slidelist',
        method: 'GET',
        params: data
    })
}
...
export const messageDetail = (data) => {
    return request({
        url: '/api/notification!message.detail',
        method: 'GET',
        params: data
    })
}
...
export const firstRechargeRewargs = () => {
    return request({
        url: '/api/syspara!getSyspara.action?code=mall_first_recharge_rewards',
        method: 'GET',
    })
}
...
export const customerServiceUrl = () => {
    return request({
        url: '/api/syspara!getSyspara.action?code=customer_service_url',
        loadingPass: true,
        method: 'GET',
    })
}
...
export const getSysparaAction = (type) => {
    return request({
        url: `/api/syspara!getSyspara.action?code=${type}`,
        method: 'GET',
    })
}
...
export const moneylogAddNotify = () => {
    return request({
        url: `/api/moneylog!addNotify.action`,
        method: 'GET',
        loadingPass: true,
    })
}
...
export const moneylogNotifyCallback = (data) => {
    return request({
        url: `/api/moneylog!notifyCallback.action`,
        method: METHODS.POST,
        data
    })
}
