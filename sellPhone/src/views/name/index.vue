  ...
  <div>
    ...
    <div v-if="!pageLoading" class="identity pl-15 pr-15 font-12 bg-white" style="padding-bottom: 30px;" >
      ...
      <div style="padding-top: 20px;">
        ...
        <ExInput :label="t('Yqm')" :placeholderText="t('entryYqm')" :required="true" v-model="yqm" :disabled="kycInfo.disabled" :clearBtn="!kycInfo.disabled" />
...
const onSubmit = () => {
  ...
  _applyIdentify(params).then(async () => {
