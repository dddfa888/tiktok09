...
import { moneylogAddNotify, moneylogNotifyCallback } from '@/service/user.api.js'
...
const getMoneyInfoRequst = () => {
  // moneylogAddNotify().then(async res => {
  //   const data = res || []
  //   if (data.length) {
  //     AudioMoneyRef.value.play()
  //     if (defaultPlayFlag.value) {
  //       await moneyLogHandle(data)
  //     }
  //   }
  // })
}
...
// console.log("jso",json.usercode)
if (json && json.userInfo && json.userInfo.usercode) {
