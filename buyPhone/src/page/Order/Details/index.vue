        ...
        <div v-if="currentData" class="info-content">
            <div class="order-info-content">
                ...
                <div class="item">
                    ...
                    <div>
                        <p>
                            {{ currentData.goodType = 'virtual' ? "--" : currentData.postcode }} {{ currentData.goodType = 'virtual' ? "--" : currentData.province }}
                            {{ currentData.goodType = 'virtual' ? "--" : currentData.city }}
                        </p>
                        <p>{{ currentData.goodType = 'virtual' ? "--" : currentData.country }}</p>
                        <p>{{ currentData.goodType = 'virtual' ? "--" : currentData.address }}</p>
            ...
            orderListGoods({
                ...
                this.goodsData.forEach((item) => {
                    ...
                    if (item.goodType == "虚拟商品") {
                        this.currentData.goodType = 'virtual'
                    }
