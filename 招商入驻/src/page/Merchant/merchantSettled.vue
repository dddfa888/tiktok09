        ...
        <div v-if="step == 2">
          ...
          <div class="content content2">
            ...
            >
              ...
              <el-form-item :label="$t('本人材料')" prop="idimg_1">
              ...
              >
                <el-input
                  ...
                  :onkeyup="
                    (ruleForm.username = ruleForm.username.replace(/\s+/g, ''))
                  "
                ></el-input>
              </el-form-item>
              <!-- <el-form-item
              ...
              <el-form-item :label="$t('再次输入确认登录密码')" prop="re_password">
                <div class="password">
                  <el-input
                    ...
                    :onkeyup="
                      (ruleForm.re_password = ruleForm.re_password.replace(
                        /\s+/g,
                        ''
                      ))
                    "
              ...
              <el-form-item :label="tabIndex == 1 ? $t('短信验证码') : $t('邮箱验证码')">
                <el-input
                  prop="verifcode"
                  v-if="itemname == 'FASTBAY'"
                  :placeholder="$t('请输入验证码')"
                  v-model="ruleForm.verifcode"
                  :onkeyup="
                    (ruleForm.verifcode = ruleForm.verifcode.replace(
                      /\s+/g,
                      ''
                    ))
                  "
              ...
              <!-- <el-form-item :label="$t('邀请码')" prop="usercode" >
                <el-input
                  ...
                  :onkeyup="
                    (ruleForm.usercode = ruleForm.usercode.replace(/\s+/g, ''))
                  "
                  clearable
                ></el-input>
              </el-form-item>-->
  ...
  methods: {
    ...
    async getCode() {
      ...
      if (this.tabIndex == 1) {
        ...
        target = this.areaCode + this.ruleForm.userPhone;
      } else {
        ...
        .validate(valid => {
          if (
            ...
            sellerRegister({
              ...
              identifying_code: this.ruleForm.verifcode
            }).then(res => {
              console.log("res ->", res);
              this.step = 3;
              this.$el
