  ...
  <div class="container" v-if="isShow">
    <div class="service-box">
      <div class="header">
        <div class="logo">
          <img
            :src="itemname == 'FamilyShop' ? require(`@/assets/image/${itemname}/sevice.png`) :itemname =='TikTok' || itemname == 'Laz'? require(`@/assets/image/${itemname}/logo.png`): require(`@/assets/image/${itemname}/logo.svg`)"
            alt
          />
          {{ itemname }} {{ $t("footer_helpLine") }}
        </div>

        <img class="icon" src="@/assets/image/icon00.png" alt @click="close" />
        <!-- </div> -->
      </div>
          ...
          <ul class="flex flex-col pt-20">
            ...
            >
              ...
              <div class="flex" :class="item.send_receive === 'send' ? 'justify-end' : ''">
                ...
                <img v-if="item.send_receive === 'send'" :src="userAvatar" class="avatar" />
              </div>
            </li>
          </ul>
        </div>
