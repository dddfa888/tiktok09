...
export default {
  ...
  created() {
    ...
    link.href =
      this.itemname == "Azedi" || this.itemname == "Sam-wholesaleShop"
        ? require(`@/assets/image/${this.itemname}/logo.svg`)
        : this.itemname == "INT Overstock"
        ? require(`@/assets/image/${this.itemname}/ico.png`)
        : this.itemname == "TikTok-Wholesale" ||
          this.itemname == "SM-wholesale shop" ||
          this.itemname == "SIMON" ||
          this.itemname == "Alibaba" ||
          this.itemname == "Sky City"
        ? require(`@/assets/image/${this.itemname}/logo.svg`)
        : this.itemname == "TikTok" || this.itemname == "Laz"
        ? require(`@/assets/image/${this.itemname}/${this.itemname}logo.png`)
        : require(`@/assets/image/${this.itemname}/${this.itemname}logo.png`);
  ...
  methods: {
    ...
    async insertIm() {
      ...
      if (this.itemname == "FamilyShop") {
        await loadJs(
          `https://lt.xhduh.com/im_create_iframe.js?router=client&id=${Math.random()}`
        );
...
.im_create_iframe_client_wrapper_open {
