  ...
  <div class="navbar pl-11 pr-24 flex justify-between items-center font-14">
    ...
    <div class="flex items-center h-full">
      ...
      <img
        ...
        alt=""
        class="w-30 h-30 ml-10 mr-6"
        style="border-radius: 50%"
      />
      <span class="mr-12 font-14 font-400"> {{ showUserName }}</span>
      <img
        :src="require('@/assets/images/nav/Union.png')"
        alt=""
    ...
    <div class="announcement" v-if="showAnnouncement">
      <div class="announcement-content">
        <el-image
          :src="announcementContentBg"
          class="announcement-content-bg"
        />
        <el-image
          :src="closeIcon"
  ...
  methods: {
    ...
    openBell() {
      ...
      window.open(
        url,
        projectTitle,
        "scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no,innerHeight=646,innerWidth=790"
      );
    },
    getVector() {
      getVector().then((res) => {
        ...
        this.$nextTick(() => {
          if (this.$refs.scrollingText) {
            let start =
              (this.$refs.scrollingText.clientWidth / 500).toFloor(0) * 1 + 1;
