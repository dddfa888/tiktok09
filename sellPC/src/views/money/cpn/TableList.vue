    ...
    <div class="table">
      <el-table border :data="tableData" stripe style="width: 100%">
        ...
        >
          <template slot-scope="scope">
            <div
              :style="{ color: scope.row.amount > 0 ? '#67C23A' : '#F56C6C' }"
            ...
            >
              ...
              <el-popover
                ...
                width="300"
                v-if="
                  scope.row.content_type == 'order-income' &&
                  scope.row.detail.length > 0
                "
              >
                <div class="show-money-content">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div
                        v-for="(sitem, sindex) in scope.row.detail"
                        :key="`s` + sindex"
                        v-if="sitem.level === index + 1"
                      >
                        <FormatNumberShow
                          :data="sitem.rebate"
                          :currency="true"
      ...
      <div style="margin-top: 20px; text-align: center">
        ...
        <!--        </el-pagination>-->
        <el-row>
          <el-button type="primary" @click="fenye('b')">{{
            $t("上一页")
          }}</el-button>
          <el-button
            type="primary"
  ...
  methods: {
    ...
    getAllData() {
      ...
      zijinjilu_post(form).then(({ data }) => {
        ...
        data?.forEach((item) => {
          if (
            this.order_options.find((res) => res.value === item.content_type)
          ) {
            arr.push(item);
          }
        });
