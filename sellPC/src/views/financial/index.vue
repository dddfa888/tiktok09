  ...
  methods: {
    ...
    report_head_action_post() {
      report_head_action({sellerId: this.info.id, content_type: this.From.content_type}).then((e) => {
        ...
        this.saleInfo.n1 = e.data.head.totalSales
        this.saleInfo.n2 = e.data.head.totalProfit
        this.saleInfo.n3 = e.data.head.orderNum
        this.saleInfo.n4 = e.data.head.orderCancel
        this.saleInfo.n5 = e.data.head.payOrder
        this.saleInfo.n6 = e.data.head.sendOutOrder
      })
    },
    // TODO: 每页几条,去请求获取数据
