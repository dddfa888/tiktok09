  ...
  methods: {
    ...
    seller_info_action() {
      seller_info_action_post({}).then((e) => {
        // this.iframeSrc="http://127.0.0.1:8848/chat/#/pc/blue?token=498f1c2527ae4a009abd5944c5f7b7db&selfimg=https://hetao-shop-test2.s3.amazonaws.com/shopAvatar/2023-12-18/4641eec9-6dc6-4e71-b265-158a6408b851.jpeg&type=shop&lang=cn"
        this.info = e.data
        ...
        if (this.$route.query.name && this.$route.query.partyid) {
          ...
          this.iframeSrc = getOrigin() + '/chat/#/pc/blue?token=' + this.Token + '&name=' + this.customerInfo.name + '&partyid=' + this.customerInfo.partyid + '&selfimg=' + this.info.avatar + '&type=shop&lang=' + lang
        } else {
          this.iframeSrc = getOrigin() + '/chat/#/pc/blue?token=' + this.Token + '&selfimg=' + this.info.avatar + '&type=shop&lang=' + lang
        }
      }).catch((e) => {
      })
    },
