...
public interface AdminUserService {
	...
	void insert(String username, String password, boolean loginAuthority, boolean enabled, String remarks, String usernameLogin,
				String ip, String parentsUsercode, String phone, boolean autoComment,String rolez);
	 ...
	 * @param money 操作金额
	 */
	void updateFrozen(String opName, String opSafeWord, String opIP, String toID, String type, BigDecimal money);

	/**
	 * 后台添加店铺
	 */
	void insertShop(String email,String phone, String password, String sellerName, String remarks, String parentsCode,
					boolean login_authority,boolean  enabled,String usernameLogin, String ip);

	/**
	 * 批量添加演示账号(邮箱号 生成地址)
	 */
    void insertUsers(int userNum, int userMoney, String usernameLogin, String ip);
}
