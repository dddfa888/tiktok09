...
//		page.setElements(format(page.getElements()));
	...
	public Page exchangePagedQuery(int pageNo, int pageSize,String startTime,String endTime,String loginPartyId,String usernameOrUid,String roleName,String targetPartyId,
		...
		Map<String,Object> parameters = new HashMap<String,Object>();
		StringBuffer queryString = new StringBuffer();
		queryString.append("SELECT party.ROLENAME AS rolename,party.USERNAME AS username,party.REMARKS AS remarks, party.USERCODE AS UID ,party.UUID AS partyId,IFNULL(wallet.MONEY,0) AS money, ");//用户
...
//		}
//		queryString.append("GROUP BY ud.PARTY_ID ");
		queryString.append("GROUP BY party.UUID, party.ROLENAME, party.USERNAME, party.REMARKS, party.USERCODE ");
