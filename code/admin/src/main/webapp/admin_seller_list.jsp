                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <select id="roleName" name="roleName" class="form-control ">
                                                ...
                                                <option value="MEMBER"
                                                        <c:if test="${roleName == 'MEMBER'}">selected="true"</c:if> >
                                                    真实商铺
                                                </option>
                                                <option value="GUEST"
                                                        <c:if test="${roleName == 'GUEST'}">selected="true"</c:if> >虚拟商铺
                                                </option>
                                            </select>
                                        </div>
                                    </div>
...
<%--                            </div>--%>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <select id="level" name="level" class="form-control ">
                                                ...
                                                <option value="0"
                                                        <c:if test="${level == '0'}">selected="true"</c:if> >0
                                                </option>
                                                <c:forEach items="${levels}" var="levelOption">
                                                    <option value="${levelOption}"
                                                            <c:if test="${level == levelOption}">selected="true"</c:if> >${levelOption}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
        ...
        <c:if test="${security.isRolesAccessible('ROLE_ROOT,ROLE_ADMIN,ROLE_AGENT')
            ...
            <a href="<%=basePath%>normal/adminUserAction!to-shop-add" class="btn btn-light" style="margin-bottom: 10px">
                <i class="fa fa-pencil"></i>添加商家账号</a>
...
<td>
    <c:choose>
        <c:when test="${item.tag == 'virtual'}">
            ${item.sellerName}
        </c:when>
        <c:otherwise>
            <a href="javascript:authenticationInfo('${item.sellerId}')">${item.sellerName}</a>
        </c:otherwise>
    </c:choose>
</td>
...
<%--                                    <td>${item.teamNum}</td>--%>
                                    ...
                                    <td><a href="#" onClick="getGoodsNumBySellerIds('${item.sellerId}')">查看</a>
                                    </td>
...
<%--                                        </c:if>--%>
<%--                                        <c:if test="${item.frozenState == 0}">--%>
                                            <fmt:formatNumber value="${item.moneyFrozen}" pattern="#0.00"/>
<%--                                        </c:if>--%>
                                    </td>
                                    <td>
                                        <fmt:formatNumber value="${item.rebate}" pattern="#0.00"/>
                                    </td>
                                    <td>
                                        <fmt:formatNumber value="${item.totalRebate}" pattern="#0.00"/>
                                    </td>

                                    <td>
                                        <c:choose>
                                            <c:when test="${item.rolename=='GUEST'}">
                                                <span class="right label label-danger">假用户</span>
                                            </c:when>
                                            <c:when test="${item.rolename=='MEMBER'}">
                                                <span class="right label label-success">真用户</span>
                                            </c:when>
                                        </c:choose>
                                    </td>
                                    <td>
...
<%--                                    <td><a href="#" onClick="getViewNumsBySellerIds('${item.sellerId}')">查看</a>--%>
<%--                                    </td>--%>
                                        ...
                                        <c:if test="${security.isRolesAccessible('ROLE_ROOT,ROLE_ADMIN')
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu"
                                                    ...
                                                    <li>
                                                        <a href="javascript:updateSeller('${item.sellerId}','${item.sellerName}','${item.recTime}','${item.freeze}','${item.black}','${item.remarks}')">修改</a>
                                                    </li>
                                                        <%--													<li><a href="javascript:reject('${item.sellerId}','${item.remarks}')">备注</a></li>--%>
                                                        <%--													<li><a href="javascript:setScore('${item.sellerId}','${item.sellerName}','${item.score}')">综合评分</a></li>--%>
                                                    <li>
                                                        <a href="javascript:setUp('${item.sellerId}','${item.baseTraffic}','${item.autoStart}','${item.autoEnd}')">设置访问量</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:setAttention('${item.sellerId}','${item.reals}','${item.fake}')">设置关注人数</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:setCreditScore('${item.sellerId}','${item.creditScore}')">设置信誉分</a>
                                                    </li>
                                                    <li><a href="javascript:setSoldNum('${item.sellerId}')">设置销量</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:updateLevel('${item.sellerId}')">修改等级</a>
                                                    </li>
                                                    <li><a href="javascript:sendTip('${item.sellerId}','${item.sellerName}')">发送通知</a>
                                                    </li>
                                                        <%--													<c:choose>--%>
                                                        <%--														<c:when test="${item.recTime == '0'}">--%>
                                                        ...
                                                        <%--													<c:choose>--%>
                                                        <%--														<c:when test="${item.frozenState == '1'}">--%>
                                                        <%--															<li><a href="javascript:unFreezeMoney('${item.sellerId}')">解冻店铺资金</a></li>--%>
                                                        <%--														</c:when>--%>
                                                        <%--														<c:otherwise>--%>
                                                        <%--															<li><a href="javascript:freezeSellerMoney(`${item.sellerId}`,`${item.money}`,`${item.sellerName}`)">冻结店铺资金</a></li>--%>
                                                        <%--														</c:otherwise>--%>

                                                        <%--													</c:choose>--%>
                                                        <%--													<c:choose>--%>
                                                        <%--														<c:when test="${item.freeze == '1'}">--%>
                                                        <%--															<li><a href="javascript:unFreezeSeller('${item.sellerId}')">解冻店铺</a></li>--%>
                                                        <%--														</c:when>--%>
                                                        <%--														<c:otherwise>--%>
                                                        <%--															<li><a href="javascript:freezeSeller(`${item.sellerId}`)">冻结店铺</a></li>--%>
                                                        <%--														</c:otherwise>--%>
                                                        <%--													</c:choose>--%>
                                                        <%--													<c:choose>--%>
                                                        <%--														<c:when test="${item.black == '1'}">--%>
                                                        ...
                                                        <%--													</c:choose>--%>
                                                    <li>
                                                        <a href="javascript:LoginFree('${item.sellerId}')">登录卖家账号</a>
                                                    </li>
                                                    ...
                                                    <c:if test="${security.isRolesAccessible('ROLE_ROOT,ROLE_ADMIN,ROLE_CUSTOMER')}">
                                                        <li class="link">
                                                            <a href="javascript:void(0);"
                                                               onclick="parent.chat('${item.usercode}')">联系商家</a>
                                                        </li>
                                                    </c:if>
                                                </ul>
                                            </div>
    ...
    <div class="form-group">
        <form action="<%=basePath%>/mall/seller/update-score"
              method="post" id="update-score">
            <input type="hidden" name="pageNo7" id="pageNo7" value="${pageNo}">
            <input type="hidden" name="sellerId7" id="sellerId7">
            <div class="col-sm-1">
                <!-- 模态框（Modal） -->
                <div class="modal fade" id="modal-update-score" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="">
                                    <input id="sellerName7" name="sellerName7"
                            ...
                            <div class="modal-body">
                                <div class="">
                                    <input id="score7" name="score7" class="form-control"
                                           oninput="this.value = this.value.match(/^([0-4](\.\d{0,1})?|5(\.0?)?)?$/)?.[0] || '';">
    ...
    <%--修改店铺--%>
    <div class="form-group">
        <form action="<%=basePath%>/mall/seller/update-seller"
              method="post" id="update-seller">
            <input type="hidden" name="pageNo8" id="pageNo8" value="${pageNo}">
            <input type="hidden" name="sellerId8" id="sellerId8">
            <div class="col-sm-1">
                <!-- 模态框（Modal） -->
                <div class="modal fade" id="modal-update-seller" tabindex="-1" role="dialog"
                     aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">店铺修改</h4>
                            </div>
                            <div class="modal-body">
                                <label class="col-sm-3 control-label form-label">店铺名</label>
                                <div class="">
                                    <input id="sellerName8" name="sellerName8" class="form-control">
                                </div>
                            </div>
                            <div class="modal-body">
                                <label class="col-sm-3 control-label form-label">备注</label>
                                <div class="">
                                    <input id="remarks8" name="remarks8" class="form-control">
                                </div>
                            </div>
                            <div class="modal-body">
                                <label class="col-sm-3 control-label form-label">店铺状态</label>
                                <div class="">
                                    <select id="status8" name="status8" class="form-control">
                                        <option value="1">推荐店铺</option>
                                        <option value="0">不推荐店铺</option>
                                    </select>
                                </div>
                            </div>
                            <div class="modal-body">
                                <label class="col-sm-3 control-label form-label">冻结状态</label>
                                <div class="">
                                    <select id="freeze8" name="freeze8" class="form-control">
                            ...
                            <div class="modal-body">
                                <label class="col-sm-3 control-label form-label">拉黑状态</label>
                                <div class="">
                                    <select id="black8" name="black8" class="form-control">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="base_traffic" name="base_traffic"
                                       class="form-control" value="${base_traffic}"
                        ...
                        <div class="modal-body">
                            ...
                            <input id="auto_start" style="width: 255px; float: left; margin-right: 10px;"
                                   name="auto_start" class="form-control " value="${auto_start}"
                                   oninput="value=value.replace(/[^\d]/g,'')"/>
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="realAttention" name="base_traffic"
                                       class="form-control" value="${realAttention}"
                                       oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="fakeAttention" name="fakeAttention"
                                       class="form-control" value="${fakeAttention}"
                                       oninput="value=value.replace(/[^\d]/g,'')">
                            </div>
                        </div>
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="allAttention" name="base_traffic"
                                       class="form-control" value="${allAttention}"
                                       oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"
                                    aria-hidden="true"></button>
                            <h4 class="modal-title">冻结金额 <span style="color: red;">（输入0意味金额被全部冻结）</span>
                            </h4>
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="NowCreditScore" name="NowCreditScore"
                                       class="form-control" value="${NowCreditScore}" readonly="true"
                                       oninput="if(value>200){value=200}else{value=value.replace(/[^\d]/g,'')}if(value.indexOf(0)==0){value=0}">
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="score" name="score"
                                       class="form-control" value="${score}"
                                       oninput="if(value>200){value=200}else{value=value.replace(/[^\d]/g,'')}if(value.indexOf(0)==0){value=0}">
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="rechargeAmount" name="rechargeAmount"
                                       class="form-control" value="${rechargeAmount}"
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="realSoldNum" name="realSoldNum"
                                       class="form-control" value="${realSoldNum}"
                                       oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="fakeSoldNum" name="fakeSoldNum"
                                       class="form-control" value="${fakeSoldNum}"
                                       oninput="value=value.replace(/[^\d]/g,'')">
                            </div>
                        </div>
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="allSoldNum" name="allSoldNum"
                                       class="form-control" value="${allSoldNum}"
                                       oninput="value=value.replace(/[^\d]/g,'')" readonly="true">
                            </div>
                        </div>
            ...
            <div class="modal fade" id="modal_set9" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <textarea name="remarks" id="remarks" class="form-control  input-lg" rows="6" cols="6"
                                  placeholder="备注信息">${remarks}</textarea>
...
<div class="form-group">
    ...
    <form action="<%=basePath%>/mall/seller/send-tip"
          method="post" id="succeededForm1">

        <input type="hidden" name="pageNo16" id="pageNo16" >
        <input type="hidden" name="sellerId16" id="sellerId16" >

        <div class="col-sm-1">
            <!-- 模态框（Modal） -->
            <div class="modal fade" id="modal_set16" tabindex="-1" role="dialog"
                 aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <input id="sellerName16" name="sellerName16"
                                       class="form-control" disabled>
                            </div>
                        </div>
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <textarea name="content16" id="content16" class="form-control  input-lg" rows="6" cols="6"
                                          placeholder="通知内容" maxlength="100"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer" style="margin-top: 0;">
                            <button type="button" class="btn " data-dismiss="modal">关闭</button>
                            <button id="sub16" type="submit" class="btn btn-default">确认</button>
                        </div>
...
<script>
    ...
    function authenticationInfo(sellerId){
        $.ajax({
            type: "get",
            url: "<%=basePath%>normal/adminKycAction!kyc-info",
            dataType : "json",
            data : {
                "sellerId" : sellerId
            },
            success : function(rep) {
                if(rep.code=='1'){
                    var obj = rep.data;
                    detail(obj.partyId, obj.name, obj.idnumber, obj.nationality, obj.idimg_1, obj.idimg_2, obj.idimg_3, obj.idname)
                }
            },
...
<script type="text/javascript">
    ...
    function updateSeller(sellerId, sellerName, recTime, freeze, black, remarks) {
        if (recTime === '0') {
            $("#status8").val('0');
        } else {
            $("#status8").val('1');
        }
        $("#sellerId8").val(sellerId);
        $("#sellerName8").val(sellerName);
        $("#freeze8").val(freeze);
        $("#black8").val(black);
        $("#remarks8").val(remarks);
        $('#modal-update-seller').modal("show");
    }

    function setScore(sellerId, sellerName, score) {
        $("#sellerId7").val(sellerId);
        $("#sellerName7").val(sellerName);
        $("#score7").val(score);
    ...
    function freezeSeller(sellerId) {
        $("#seller_Id44").val(sellerId);
        swal({
            title: "是否冻结该商家?冻结后该商家不可进行提现",
            text: "",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            ...
            document.getElementById("succeededForm44").submit();
        });
    ...
    function unFreezeSeller(sellerId) {
        $("#seller_Id45").val(sellerId);
        swal({
            title: "是否解冻该商家?",
            text: "",
            type: "warning",
            ...
            document.getElementById("succeededForm45").submit();
        });
    ...
    function sendTip(sellerId,sellerName) {
        $("#sellerId16").val(sellerId);
        $("#sellerName16").val(sellerName);
        $('#modal_set16').modal("show");
    }
