...
<%--                            <input type="hidden" name="filter_ip" id="filter_ip" value="${filter_ip}" >--%>
							...
							<input type="hidden" name="tjj" id="tjj" value="${tjj}" >
...
<%--							<h5>代金卷设置</h5>--%>
<%--							<div class="form-group">--%>
<%--								<label class="col-sm-4 control-label form-label">代金卷1</label>--%>
<%--								<div class="col-sm-6" style="display: flex; align-items: center;">--%>
<%--									<div class="input-group" style="margin-right: 10px;">--%>
<%--										<span class="input-group-addon" style="width: auto;">满</span>--%>
<%--										<input id="djj" name="djj" class="form-control" value="${djj}" style="width: auto; flex-grow: 1;" />--%>
<%--									</div>--%>
<%--									<div class="input-group">--%>
<%--										<span class="input-group-addon" style="width: auto;">减</span>--%>
<%--										<input id="djja" name="djja" class="form-control" value="${djja}" style="width: auto; flex-grow: 1;" />--%>
<%--									</div>--%>
<%--								</div>--%>

<%--							</div>--%>
<%--							<div class="form-group">--%>
<%--								<label class="col-sm-4 control-label form-label">代金卷2</label>--%>
<%--								<div class="col-sm-6" style="display: flex; align-items: center;">--%>
<%--									<div class="input-group" style="margin-right: 10px;">--%>
<%--										<span class="input-group-addon" style="width: auto;">满</span>--%>
<%--										<input id="djj2" name="djj2" class="form-control" value="${djj2}" style="width: auto; flex-grow: 1;" />--%>
<%--									</div>--%>
<%--									<div class="input-group">--%>
<%--										<span class="input-group-addon" style="width: auto;">减</span>--%>
<%--										<input id="djjb" name="djjb" class="form-control" value="${djjb}" style="width: auto; flex-grow: 1;" />--%>
<%--									</div>--%>
<%--								</div>--%>
<%--							</div>--%>
<%--							<div class="form-group">--%>
<%--								<label class="col-sm-4 control-label form-label">代金卷3</label>--%>
<%--								<div class="col-sm-6" style="display: flex; align-items: center;">--%>
<%--									<div class="input-group" style="margin-right: 10px;">--%>
<%--										<span class="input-group-addon" style="width: auto;">满</span>--%>
<%--										<input id="djj3" name="djj3" class="form-control" value="${djj3}" style="width: auto; flex-grow: 1;" />--%>
<%--									</div>--%>
<%--									<div class="input-group">--%>
<%--										<span class="input-group-addon" style="width: auto;">减</span>--%>
<%--										<input id="djjc" name="djjc" class="form-control" value="${djjc}" style="width: auto; flex-grow: 1;" />--%>
<%--									</div>--%>
<%--								</div>--%>
<%--							</div>--%>
							...
							<h5>店铺管理参数</h5>
							<div class="form-group">
								<label class="col-sm-4 control-label form-label">店铺最小下架商品数(低于设置不能下架商品)</label>
								<div class="col-sm-3">
									<div class="input-group">
										<input id="seller_min_goods_off_number" name="seller_min_goods_off_number" class="form-control " value="${seller_min_goods_off_number}" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label form-label">店铺最大上架商品数(高于设置不能上架商品)</label>
								<div class="col-sm-3">
									<div class="input-group">
										<input id="seller_min_goods_off_number" name="seller_max_goods_on_number" class="form-control " value="${seller_max_goods_on_number}" />
									</div>
								</div>
							</div>
							<h5>提现</h5>
