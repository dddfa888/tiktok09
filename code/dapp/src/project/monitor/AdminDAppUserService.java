...
public interface AdminDAppUserService {
	...
	public void save(String address, boolean login_authority, boolean withdraw_authority, boolean enabled,
					 String remarks, String code, String operator, String ip,String role);
	 ...
	 * @param ip
	 */
	public void update(String partyId,boolean login_authority, boolean enabled, boolean withdraw_authority, String remarks,
	 ...
	 *更新用户信息
	 */
	void update2(String partyId,boolean login_authority, boolean enabled, boolean withdraw_authority, String remarks,
					   String operatorUsername, String ip, boolean autoComment, String withdrawAddress,
