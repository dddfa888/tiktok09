...
public enum OrderStatusEnum implements Serializable {
    ...
    REFUND_FAIL(10, "退款失败"),
    DISTRIBUTION_STATUS1(20, "快件已出库,正在发往下一站"),
    DISTRIBUTION_STATUS2(21, "快件已装车,正在发往中转中心"),
    DISTRIBUTION_STATUS3(22, "快递到达区域中转站,正在派送至城市分拣中心"),
    DISTRIBUTION_STATUS4(23, "快递送达城市分拣中心,正在分拣"),
    DISTRIBUTION_STATUS5(24, "快递分拣完毕,正在出库派送中");
    // DISTRIBUTION_STATUS6(25, "用户已签收,发货完成,感谢您的等待!"),;
