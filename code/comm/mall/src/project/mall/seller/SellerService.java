...
public interface SellerService {
     ...
     * 支付订单
     */
    Long payOrderNum(String sellerId, String startTime, String endTime);

    /**
     * 送货订单
     */
    Long sendOutOrderNum(String sellerId, String startTime, String endTime);

    Map<String, Object> countStatus(String sellerId, String startTime, String endTime);
}
