...
//    Integer autoVirtualOrderdelivery();
     ...
     * 管理释放佣金
     */
    void updateProfit(String orderId,String admin);
     ...
     * 采购24小时自动收货释放佣金
     */
    Integer updateVirtualOrder();

    List<MallOrdersPrize> listRealAutoOrderInfo();

    /**
     * 统计滞纳金
     */
    double getLateFee(String partyId);

    double getTotalRebate(String sellerId);
}
