...
//        ResultObject resultObject=new ResultObject();
    ...
    public Object info(HttpServletRequest request){
        ...
        int goodsType=pl.getGoodsType()==null?0:pl.getGoodsType();
...
//        虚假评论的username为'0'
        ...
        country=StringUtils.isEmptyString(addressDetail.get(0))?country:addressDetail.get(0);
        province=StringUtils.isEmptyString(addressDetail.get(1))?province:addressDetail.get(1);
        city=StringUtils.isEmptyString(addressDetail.get(1))?city:addressDetail.get(2);
        ...
        if(goodsType==1){
            username=address=country=city=province=postcode=contacts="-";
        }
