...
public interface RechargeBlockchainService {
	...
	List<RechargeBlockchain> findByPartyIdAndSucceeded(Serializable partyId, int succeeded);
	...
	public Map saveSucceeded(String order_no, String operator, String transfer_usdt, String success_amount,
							 double rechargeCommission,String remarks,int type);
	/**
	 *
	 * @param order_no 订单
	 */
	void saveSucceeded(String order_no);
