...
//		}
    ...
    public Map saveSucceeded(String order_no, String safeword, String operator_username, String transfer_usdt,
                             String success_amount, double rechargeCommission,String remarks,int type) {
        ...
        Map map = rechargeBlockchainService.saveSucceeded(order_no, operator_username,
                transfer_usdt, success_amount, rechargeCommission,remarks,type);
        try {
...
//        首次充值满足条件赠送邀请礼金
    ...
    public void saveReject(String id, String failure_msg, String userName, String partyId) {
        ...
        simpleNotificationService.addSinge(partyId,recharge.getPartyId()+"","您的充值失败,金额","充值",recharge.getAmount().toString());
