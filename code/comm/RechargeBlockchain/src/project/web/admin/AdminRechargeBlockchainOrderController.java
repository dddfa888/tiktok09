...
//				}
    ...
    public ModelAndView onsucceeded(HttpServletRequest request) {
        ...
        int type=0;
        if(typeStr!=null&&typeStr.equals("1")){
            type=1;
        }
...
//			double successAmount = Double.valueOf(request.getParameter("success_amount")).doubleValue();
            ...
            synchronized (obj) {
                Map map = this.adminRechargeBlockchainOrderService.saveSucceeded(order_no, safeword, this.getUsername_login(),
                ...
                if (flag) {
                    ...
                    simpleNotificationService.addSinge(fid, (String) map.get("pid"), "您的充值成功,金额", "充值", success_amount);
                }
