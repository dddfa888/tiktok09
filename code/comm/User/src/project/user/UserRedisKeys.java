...
public class UserRedisKeys {
	 ...
	 * 多点登录token
	 */
	public final static String PLAT_FROM_TOKEN_UUID="PLAT_FROM_TOKEN_UUID:";
	public final static String PLAT_FROM_TOKEN_DATA="PLAT_FROM_TOKEN_DATA:";
	public final static String SYSTEM_WIN = "win";
	public final static String SYSTEM_LINUX = "linux";

	// 7 天，单位：秒
	public final static int EXPIRE_SECONDS = 7 * 24 * 60 * 60;
}
