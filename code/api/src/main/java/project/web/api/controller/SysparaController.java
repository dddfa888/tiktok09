...
public class SysparaController {
	 ...
	 * 获取客服在线时间
	 */
	@RequestMapping("api/customerServiceTimeRange")
	public Object getCustomerServiceTimeRange() {
		ResultObject resultObject = new ResultObject();
		Map<String, Object> error=new HashMap<>();
		try {
			Map<String, Object> data = localSysparaService.getCustomerServiceTimeRange();
			resultObject.setData(data);
