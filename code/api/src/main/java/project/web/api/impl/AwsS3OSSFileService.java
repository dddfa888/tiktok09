...
public class AwsS3OSSFileService {
    ...
    private final String bucketName="tiktokqiantai";
    private final String tempFilePath="E:/project2.0/";
    ...
    public S3Client getS3Client() {
        ...
        AwsBasicCredentials awsCreds = AwsBasicCredentials.create(
                "AKIA2UC3FDXR473JALZ7", // 替换为你的 AWS Access Key
                "bHH3HxzBHm28SSwyUq4DzbntATj3KIQnk7tFo5Gd" // 替换为你的 AWS Secret Key
        );

        // 创建 S3Client 并传入硬编码的凭证
        S3Client s3Client = S3Client.builder()
                .region(Region.AP_SOUTHEAST_1) // 选择适当的区域
