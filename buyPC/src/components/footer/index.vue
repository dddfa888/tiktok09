  ...
  <div class="footer">
    <div class="app-container">
      <div class="footer-wrapper flex-start">
        <div class="footer-title flex-start">
          <img
            ...
            :src="
              itemname == 'AntMall'
                ? require(`@/assets/image/${itemname}/logo.svg`)
            ...
            :style="
              itemname == 'SM-wholesale shop'
                ? 'height:38px'
                : itemname === 'TikTok' || itemname === 'TikTok-Wholesale'
      ...
      <!--<div class="footer-wrapper">
        <div class="flex-start sec">
          ...
          <div class="argos">
            <div class="left">
              ...
              <div
                class="dec"
              >{{ itemname == 'TikTok' ? $t("message.home.TikTokFoot") :$t("message.home.footdec", { name: itemname,num: itemname == 'INT Overstock' ? 180 : 112 ,coin: itemname == 'Argos' || itemname == 'INT Overstock' ? 'USDT/USDC/ETH/BTC':'USDT/ETH/BTC'}) }}</div>
            </div>
            <div
              class="right"
        ...
        >
          <img v-for="(i, index) in logoList" :key="index" :src="i.url" alt @click="i.clickEvent" />
        </div>
      </div>-->
      <div class="footer-bottom" v-if="itemname !== 'INT Overstock'">
        <p style="text-align: center; margin-bottom: 15px">
          {{
            itemname !== "TikTok"
              ? $t("message.home.footTip", { name: itemname })
              : $t("message.home.footTipTikTok")
          }}
        </p>
